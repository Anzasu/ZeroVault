...
import 'see_pass_page_model.dart';
export 'see_pass_page_model.dart';

class SeePassPageWidget extends StatefulWidget {
  const SeePassPageWidget({super.key});
...
class _SeePassPageWidgetState extends State<SeePassPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeePassPageModel());
