import 'package:zero_vault/pages/edit_sub_page/edit_sub_page_widget.dart';
        ...
        child: AppBar(
          ...
          actions: [
            Align(
              alignment: AlignmentDirectional(0.0, 0.0),
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(80.0, 30.0, 77.0, 0.0),
                                                          ...
                                                          children: [
                                                            FlutterFlowIconButton(
                                                              ...
                                                              icon: Icon(
                                                               ...
                                                               onPressed: () async {
                                                                context.pushNamed(EditSubPageWidget.routeName);
                                                                print('Edit pressed');
                                                                },
                                                            ),
                                                            FlutterFlowIconButton(
                                                              ...
                                                              onPressed: () {
                                                                context.pushNamed(SeePassPageWidget.routeName);
                                                                print(
                                                                    'SeePass pressed ...');
                                                              },
                                                            ),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        // List items (similar to first tab)
                                        Padding(
                                          padding: EdgeInsetsDirectional
                                              .fromSTEB(0.0, 0.0, 0.0, 9.0),
                                          child: ListView.builder(
